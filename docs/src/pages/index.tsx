...
const Home: React.FC = () => {
  const [highlightFastSection, setHighlightFastSection] = useState(false);
  function demonstrateLowLatency() {
    setHighlightFastSection(true);
    setTimeout(() => {
      setHighlightFastSection(false);
    }, validationLatency);
  }
  return (
    <Layout title="Sesh">
        ...
        <div css={featureStyle}>
          ...
          <div>
            ...
            <p>
              ...
              free sessions per month before you are charged. This means that
              for small projects where rate limits are not a problem, you can
              use Sesh for free. <em>No credit card is required.</em>
            </p>
          </div>
        </div>
        <div
          css={css`
            ${featureStyle} ${highlightFastSection &&
            tw`bg-purple-050 rounded-lg`}
          `}
        >
          ...
          <div>
            ...
            <p>
              ...
              its token.{" "}
              <button className="tertiary" onClick={demonstrateLowLatency}>
                How fast is that?
              </button>
            </p>
          </div>
        ...
        <div css={featureStyle}>
          ...
          <div>
            ...
            <p>
              ...
              <a href="https://github.com/RobbieGM/sesh">GitHub</a>. You can
              even run a copy of Sesh&rsquo;s APIs on-premises to reduce
              latency.
            </p>
          </div>
        </div>
      ...
      <section>
        ...
        <ul css={tw`pl-6 list-disc`}>
          ...
          <li>
            ...
            &mdash;an increasingly popular authentication scheme where tokens
            are issued by the server and stored with their metadata by the
            client. These sessions are verified cryptographically.
          </li>
        </ul>
        <table
          css={css`
